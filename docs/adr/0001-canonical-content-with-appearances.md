...
- The Library and search results display a **primary appearance** (earliest by default) for the edition/category/issue shown, with the other appearances available as provenance ("also in TLDR AI").
